...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    localized: {
      bn: {
        ...
        description: 'PDF ফাইলকে সহজে এডিটেবল মাইক্রোসফট ওয়ার্ড (.docx) ফাইলে রূপান্তর করুন শতভাগ নিরাপদে।',
        seo: {
  ...
  },
  {
    ...
    localized: {
      bn: {
        name: 'কম্প্রেস PDF',
        description: 'ডকুমেন্টের স্পষ্টতা বজায় রেখে PDF ফাইলের সাইজ উল্লেখযোগ্যভাবে কমান।',
        seo: {
